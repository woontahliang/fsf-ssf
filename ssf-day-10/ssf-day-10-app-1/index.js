...
// sorttitle is optional. Default is order by title and sort by ASC. Will include order by title if sorttitle is not undefined and not empty. Will sort by ASC or DESC if sorttitle is not undefined and not empty.
// sortauthor is optional. Will include order by author if sortauthor is not undefined and not empty. Will sort by ASC or DESC if sortauthor is not undefined and not empty.
